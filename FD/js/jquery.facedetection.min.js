...
! function(a) {
    function b(a, b) {
        if (a.length > 1) {
            for (var c = {}, d = 0; d < b.length; d++) c[b[d]] = a[d];
            return c
        }
    ...
    try {
        var d = function() {
                ...
                for (var a = document.getElementsByTagName("script"), b = 0; b < a.length; b++)
                    if (a[b].src.match(/(jquery\.facedetection(\.min)?\.js)|\/ccv\.js/)) return a[b].src
            },
            e = d()
    } catch (f) {}
    if (void 0 === g) {
        var g = function(a, b) {
            "use strict";
            return g.core[b.toString()] = b().core,
                function() {
                    var c, d, e, f;
                    if (arguments.length > 1)
                        for (d = arguments[arguments.length - 2], e = arguments[arguments.length - 1], f = new Array(arguments.length - 2), c = 0; c < arguments.length - 2; c++) f[c] = arguments[c];
                    else d = arguments[0].async, e = arguments[0].worker, f = arguments[0], delete f.async, delete f.worker, f = [f];
                    var g = {
                            shared: {}
                        },
                        h = b.apply(g, f);
                    return d ? function(d) {
                        var i = 0,
                            j = new Array(e),
                            k = h.pre.apply(g, [e]);
                        for (c in g.shared) "function" == typeof g.shared[c] ? delete g.shared[c] : void 0 !== g.shared[c].tagName && delete g.shared[c];
                        for (c = 0; e > c; c++) {
                            var l = new Worker(a);
                            l.onmessage = function(a) {
                                return function(b) {
                                    j[a] = "string" == typeof b.data ? JSON.parse(b.data) : b.data, i++, i == e && d(h.post.apply(g, [j]))
                                }
                            }(c);
                            var m = {
                                input: k[c],
                            ...
                            try {
                                ...
                                l.postMessage(JSON.stringify(m))
                            }
                        }
                    } : h.post.apply(g, [
                        [h.core.apply(g, [h.pre.apply(g, [1])[0], 0, 1])]
                    ])
                }
        };
        g.core = {}
    ...
    var h = {
        pre: function(a) {
            if ("img" == a.tagName.toLowerCase()) {
                ...
                document.body.appendChild(a), b.width = a.offsetWidth, b.style.width = a.offsetWidth.toString() + "px", b.height = a.offsetHeight, b.style.height = a.offsetHeight.toString() + "px", document.body.removeChild(a);
        ...
        grayscale: function(a) {
            for (var b, c, d = a.getContext("2d"), e = d.getImageData(0, 0, a.width, a.height), f = e.data, g = a.width * a.height * 4; g > 0;) f[g -= 4] = f[b = g + 1] = f[c = g + 2] = .3 * f[g] + .59 * f[b] + .11 * f[c];
            return d.putImageData(e, 0, 0), a
        },
        array_group: function(a, b) {
            var c, d, e = new Array(a.length);
            ...
            for (c = 0; c < a.length; c++)
                if (e[c].element) {
                    for (var f = c; - 1 != e[f].parent;) f = e[f].parent;
                    for (d = 0; d < a.length; d++)
                        if (c != d && e[d].element && b(e[c].element, e[d].element)) {
                            for (var g = d; - 1 != e[g].parent;) g = e[g].parent;
                            if (g != f) {
                                e[f].rank > e[g].rank ? e[g].parent = f : (e[f].parent = g, e[f].rank == e[g].rank && e[g].rank++, f = g);
                                for (var h, i = d; - 1 != e[i].parent;) h = i, i = e[i].parent, e[h].parent = f;
                                for (i = c; - 1 != e[i].parent;) h = i, i = e[i].parent, e[h].parent = f
                            }
                        }
                }
            ...
            for (c = 0; c < a.length; c++) {
                ...
                var l = c;
                if (e[l].element) {
                    for (; - 1 != e[l].parent;) l = e[l].parent;
                    e[l].rank >= 0 && (e[l].rank = ~k++), d = ~e[l].rank
                }
                j[c] = d
            }
            return {
        ...
        detect_objects: g(e, function() {
            function a() {
                var a = this.shared.canvas,
                    b = this.shared.interval,
                    c = this.shared.scale,
                    d = this.shared.next,
                    e = this.shared.scale_upto,
                    f = new Array(4 * (e + 2 * d)),
                    g = new Array(4 * (e + 2 * d));
                f[0] = a, g[0] = {
                    width: f[0].width,
                    height: f[0].height,
                    data: f[0].getContext("2d").getImageData(0, 0, f[0].width, f[0].height).data
                };
                var h;
                for (h = 1; b >= h; h++) f[4 * h] = document.createElement("canvas"), f[4 * h].width = Math.floor(f[0].width / Math.pow(c, h)), f[4 * h].height = Math.floor(f[0].height / Math.pow(c, h)), f[4 * h].getContext("2d").drawImage(f[0], 0, 0, f[0].width, f[0].height, 0, 0, f[4 * h].width, f[4 * h].height), g[4 * h] = {
                    width: f[4 * h].width,
                    height: f[4 * h].height,
                    data: f[4 * h].getContext("2d").getImageData(0, 0, f[4 * h].width, f[4 * h].height).data
                };
                for (h = d; e + 2 * d > h; h++) f[4 * h] = document.createElement("canvas"), f[4 * h].width = Math.floor(f[4 * h - 4 * d].width / 2), f[4 * h].height = Math.floor(f[4 * h - 4 * d].height / 2), f[4 * h].getContext("2d").drawImage(f[4 * h - 4 * d], 0, 0, f[4 * h - 4 * d].width, f[4 * h - 4 * d].height, 0, 0, f[4 * h].width, f[4 * h].height), g[4 * h] = {
                    width: f[4 * h].width,
                    height: f[4 * h].height,
                    data: f[4 * h].getContext("2d").getImageData(0, 0, f[4 * h].width, f[4 * h].height).data
                };
                for (h = 2 * d; e + 2 * d > h; h++) f[4 * h + 1] = document.createElement("canvas"), f[4 * h + 1].width = Math.floor(f[4 * h - 4 * d].width / 2), f[4 * h + 1].height = Math.floor(f[4 * h - 4 * d].height / 2), f[4 * h + 1].getContext("2d").drawImage(f[4 * h - 4 * d], 1, 0, f[4 * h - 4 * d].width - 1, f[4 * h - 4 * d].height, 0, 0, f[4 * h + 1].width - 2, f[4 * h + 1].height), g[4 * h + 1] = {
                    width: f[4 * h + 1].width,
                    height: f[4 * h + 1].height,
                    data: f[4 * h + 1].getContext("2d").getImageData(0, 0, f[4 * h + 1].width, f[4 * h + 1].height).data
                }, f[4 * h + 2] = document.createElement("canvas"), f[4 * h + 2].width = Math.floor(f[4 * h - 4 * d].width / 2), f[4 * h + 2].height = Math.floor(f[4 * h - 4 * d].height / 2), f[4 * h + 2].getContext("2d").drawImage(f[4 * h - 4 * d], 0, 1, f[4 * h - 4 * d].width, f[4 * h - 4 * d].height - 1, 0, 0, f[4 * h + 2].width, f[4 * h + 2].height - 2), g[4 * h + 2] = {
                    width: f[4 * h + 2].width,
                    height: f[4 * h + 2].height,
                    data: f[4 * h + 2].getContext("2d").getImageData(0, 0, f[4 * h + 2].width, f[4 * h + 2].height).data
                }, f[4 * h + 3] = document.createElement("canvas"), f[4 * h + 3].width = Math.floor(f[4 * h - 4 * d].width / 2), f[4 * h + 3].height = Math.floor(f[4 * h - 4 * d].height / 2), f[4 * h + 3].getContext("2d").drawImage(f[4 * h - 4 * d], 1, 1, f[4 * h - 4 * d].width - 1, f[4 * h - 4 * d].height - 1, 0, 0, f[4 * h + 3].width - 2, f[4 * h + 3].height - 2), g[4 * h + 3] = {
                    width: f[4 * h + 3].width,
                    height: f[4 * h + 3].height,
                    data: f[4 * h + 3].getContext("2d").getImageData(0, 0, f[4 * h + 3].width, f[4 * h + 3].height).data
                };
                return [g]
            }

            function c(a) {
                var b, c, d, e, f, g, h = this.shared.cascade,
                    i = (this.shared.interval, this.shared.scale),
                    j = this.shared.next,
                    k = this.shared.scale_upto,
                    l = 1,
                    m = 1,
                    n = [0, 1, 0, 1],
                    o = [0, 0, 1, 1],
                    p = [];
                for (b = 0; k > b; b++) {
                    var q = a[4 * b + 8 * j].width - Math.floor(h.width / 4),
                        r = a[4 * b + 8 * j].height - Math.floor(h.height / 4),
                        s = [4 * a[4 * b].width, 4 * a[4 * b + 4 * j].width, 4 * a[4 * b + 8 * j].width],
                        t = [16 * a[4 * b].width - 16 * q, 8 * a[4 * b + 4 * j].width - 8 * q, 4 * a[4 * b + 8 * j].width - 4 * q];
                    for (c = 0; c < h.stage_classifier.length; c++) {
                        var u = h.stage_classifier[c].orig_feature,
                            v = h.stage_classifier[c].feature = new Array(h.stage_classifier[c].count);
                        for (d = 0; d < h.stage_classifier[c].count; d++)
                            for (v[d] = {
                                    size: u[d].size,
                                    px: new Array(u[d].size),
                                    pz: new Array(u[d].size),
                                    nx: new Array(u[d].size),
                                    nz: new Array(u[d].size)
                                }, g = 0; g < u[d].size; g++) v[d].px[g] = 4 * u[d].px[g] + u[d].py[g] * s[u[d].pz[g]], v[d].pz[g] = u[d].pz[g], v[d].nx[g] = 4 * u[d].nx[g] + u[d].ny[g] * s[u[d].nz[g]], v[d].nz[g] = u[d].nz[g]
                    }
                    for (g = 0; 4 > g; g++) {
                        var w = [a[4 * b].data, a[4 * b + 4 * j].data, a[4 * b + 8 * j + g].data],
                            x = [8 * n[g] + o[g] * a[4 * b].width * 8, 4 * n[g] + o[g] * a[4 * b + 4 * j].width * 4, 0];
                        for (f = 0; r > f; f++) {
                            for (e = 0; q > e; e++) {
                                var y = 0,
                                    z = !0;
                                for (c = 0; c < h.stage_classifier.length; c++) {
                                    y = 0;
                                    var A = h.stage_classifier[c].alpha,
                                        v = h.stage_classifier[c].feature;
                                    for (d = 0; d < h.stage_classifier[c].count; d++) {
                                        var B, C, D = v[d],
                                            E = w[D.pz[0]][x[D.pz[0]] + D.px[0]],
                                            F = w[D.nz[0]][x[D.nz[0]] + D.nx[0]];
                                        if (F >= E) y += A[2 * d];
                                        else {
                                            var G, H = !0;
                                            for (G = 0; G < D.size; G++) {
                                                if (D.pz[G] >= 0 && (B = w[D.pz[G]][x[D.pz[G]] + D.px[G]], E > B)) {
                                                    if (F >= B) {
                                                        H = !1;
                                                        break
                                                    }
                                                ...
                                                if (D.nz[G] >= 0 && (C = w[D.nz[G]][x[D.nz[G]] + D.nx[G]], C > F)) {
                                                    if (C >= E) {
                                                        H = !1;
                                                        break
                                                    }
                                    ...
                                    if (y < h.stage_classifier[c].threshold) {
                                        z = !1;
                                        break
                                    }
                                }
            ...
            function d(a) {
                {
                    var b, c, d = this.shared.min_neighbors,
                        e = this.shared.cascade;
                    this.shared.interval, this.shared.scale, this.shared.next, this.shared.scale_upto
                }
                for (b = 0; b < e.stage_classifier.length; b++) e.stage_classifier[b].feature = e.stage_classifier[b].orig_feature;
                if (a = a[0], d > 0) {
                    var f = h.array_group(a, function(a, b) {
                    ...
                    for (b = 0; b < a.length; b++) {
                        var k = a[b],
                            l = i[b];
                        0 == j[l].neighbors && (j[l].confidence = k.confidence), ++j[l].neighbors, j[l].x += k.x, j[l].y += k.y, j[l].width += k.width, j[l].height += k.height, j[l].confidence = Math.max(j[l].confidence, k.confidence)
                    }
                    var m = [];
                    for (b = 0; g > b; b++) {
                        var n = j[b].neighbors;
                        n >= d && m.push({
                            x: (2 * j[b].x + n) / (2 * n),
                            y: (2 * j[b].y + n) / (2 * n),
                            width: (2 * j[b].width + n) / (2 * n),
                            height: (2 * j[b].height + n) / (2 * n),
                            neighbors: j[b].neighbors,
                            confidence: j[b].confidence
                        })
                    }
                    var o = [];
                    for (b = 0; b < m.length; b++) {
                        ...
                        for (c = 0; c < m.length; c++) {
                            var q = m[c],
                                r = Math.floor(.25 * q.width + .5);
                            if (b != c && k.x >= q.x - r && k.y >= q.y - r && k.x + k.width <= q.x + q.width + r && k.y + k.height <= q.y + q.height + r && (q.neighbors > Math.max(3, k.neighbors) || k.neighbors < 3)) {
                                p = !1;
                                break
                            }
                        }
            ...
            if (void 0 !== this.shared) {
                var e = b(arguments, ["canvas", "cascade", "interval", "min_neighbors"]);
                this.shared.canvas = e.canvas, this.shared.interval = e.interval, this.shared.min_neighbors = e.min_neighbors, this.shared.cascade = e.cascade, this.shared.scale = Math.pow(2, 1 / (e.interval + 1)), this.shared.next = e.interval + 1, this.shared.scale_upto = Math.floor(Math.log(Math.min(e.canvas.width / e.cascade.width, e.canvas.height / e.cascade.height)) / Math.log(this.shared.scale));
                var f;
                for (f = 0; f < this.shared.cascade.stage_classifier.length; f++) this.shared.cascade.stage_classifier[f].orig_feature = this.shared.cascade.stage_classifier[f].feature
            }
            return {
                pre: a,
                core: c,
    ...
    onmessage = function(a) {
        var b = "string" == typeof a.data ? JSON.parse(a.data) : a.data,
            ...
            d = g.core[b.name].apply(c, [b.input, b.id, b.worker]);
        try {
            postMessage(d)
        } catch (e) {
            postMessage(JSON.stringify(d))
        }
    }, a.fn.faceDetection = function(b) {
        "use strict";
        var d, e = {
            interval: 4,
            minNeighbors: 1,
        ...
        return a.isFunction(b) ? e.complete = b : a.extend(e, b), this.each(function() {
            function b() {
                var a, b;
                if (d = (new Date).getTime(), g.is("img")) a = new Image, a.src = g.attr("src"), a.crossOrigin = g.attr("crossorigin"), b = h.pre(a);
                else if (g.is("video") || g.is("canvas")) {
                    var i, j;
                    a = g[0], i = document.createElement("canvas"), i.setAttribute("width", a.videoWidth || a.width), i.setAttribute("height", a.videoHeight || a.height), j = i.getContext("2d"), j.drawImage(a, 0, 0), b = h.pre(i)
                }
                e.grayscale && (b = h.grayscale(b));
                try {
                    e.async && window.Worker ? h.detect_objects({
                        canvas: b,
                        cascade: c,
                        interval: e.interval,
                        min_neighbors: e.minNeighbors,
                        worker: 1,
                        async: !0
                    })(f) : f(h.detect_objects({
                        canvas: b,
                        cascade: c,
                        interval: e.interval,
                        min_neighbors: e.minNeighbors
                    ...
                    e.error.apply(g, [2, k.message]), e.complete.apply(g, [!1])
                }
            }

            function f(a) {
                for (var b = a.length, c = [], f = 0; b > f; ++f) null !== e.confidence && a[f].confidence <= e.confidence || (a[f].positionX = j.left + a[f].x, a[f].positionY = j.top + a[f].y, a[f].offsetX = i.left + a[f].x, a[f].offsetY = i.top + a[f].y, a[f].scaleX = k, a[f].scaleY = l, c.push(a[f]));
                c.time = (new Date).getTime() - d, e.complete.apply(g, [c])
            }
            var g = a(this),
                i = g.offset(),
                j = g.position(),
                k = g.width() / (this.naturalWidth || this.videoWidth) || 1,
                l = g.height() / (this.naturalHeight || this.videoHeight) || 1;
            return g.is("img, video, canvas") ? b() : (e.error.apply(g, [1, "Face detection is possible on images, videos and canvas only."]), void e.complete.apply(g, [
                []
            ]))
        })
    }
